...
export const components = [
  ...
  { slug: "button", title: "Button", description: "A native button. Sky key. Press stamps it in." },
  ...
  { slug: "menu", title: "Menu", description: "A hairline plate of seated rows. Anchored to the trigger." },
